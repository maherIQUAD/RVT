...
from Defenses.bijection_backdoor_embedding import BackdoorTrainer
    ...
    if attack == 'FGSM': 
        ...
        for i, (data, target) in enumerate(val_loader):
            if i%2==0: 
                ...
                save_image(adv_example, os.path.join(cfg.DATASET.ROOT, f'adv_image_{i}.png'))
